...
def movement(index_initial, yell_leader1, final_pos, yell_leader2, position_yell2, arrow):
    """
    ...
    if next_space > 0:  # if position progress
        for value in range(next_space+1):
            ...
            screen.blit(yell_leader1, board_position[index_initial + value])
            pygame.display.flip()  # necessary for images to appear
            if final_pos == position_yell2:
                same_spot(yell_leader1, yell_leader2, final_pos)  # a function runs if the two images are on the same game piece
        ...
        for value in range(-next_space):
            ...
            screen.blit(yell_leader1, board_position[index_initial - value])
            if final_pos == position_yell2:
                same_spot(yell_leader1, yell_leader2, final_pos)
    else:  # for no progress
        screen.blit(board, [0, 0])
        screen.blit(yell_leader2, board_position[position_yell2])
        screen.blit(yell_leader1, board_position[index_initial])
        if final_pos == position_yell2:
            same_spot(yell_leader1, yell_leader2, final_pos)
...
def card_choice_display(card1, card2, player):
    ...
    random_card = pygame.image.load('C:\\Users\\kayla\\Documents\\ENGR 102\\Final- Board Game\\Randomcard.png')
...
def player_menu3(position_grey):
    ...
    while enter is False:
        ...
        for event in pygame.event.get():
            ...
            pygame.display.flip()
            if 20 < mouse_position[0] < 150 and 100 < mouse_position[1] < 400:
                position = [20, 130]
                pygame.display.flip()
            elif 260 < mouse_position[0] < 390 and 100 < mouse_position[1] < 400:
                position = [270, 130]
                pygame.display.flip()
            elif 500 < mouse_position[0] < 620 and 100 < mouse_position[1] < 400:
                position = [490, 130]
                pygame.display.flip()
            elif 730 < mouse_position[0] < 860 and 100 < mouse_position[1] < 400:
                position = [710, 130]
                pygame.display.flip()
            elif 930 < mouse_position[0] < 1100 and 100 < mouse_position[1] < 400:
                position = [930, 130]
                pygame.display.flip()
            else:
                position = [-400, 100]
            if event.type == pygame.MOUSEBUTTONDOWN:
                if 20 < mouse_position[0] < 150 and 100 < mouse_position[1] < 300:
                    position2 = [20, 130]
                    if position2 == position_grey:
                        position_w = [200,500]  # if position is the same as player 1, gives warning
                    else:
                        return yell_1
                elif 260 < mouse_position[0] < 390 and 100 < mouse_position[1] < 300:
                    position2 = [270, 130]
                    if position2 == position_grey:
                        position_w = [200, 500]
                    else:
                        return yell_2
                elif 500 < mouse_position[0] < 620 and 100 < mouse_position[1] < 300:
                    position2 = [490, 130]
                    if position2 == position_grey:
                        position_w = [200, 500]
                    else:
                        return yell_3
                elif 730 < mouse_position[0] < 860 and 100 < mouse_position[1] < 300:
                    position2 = [710, 130]
                    if position2 == position_grey:
                        position_w = [200, 500]
                    else:
                        return yell_4
                elif 930 < mouse_position[0] < 1100 and 100 < mouse_position[1] < 300:
                    position2 = [930, 130]
                    if position2 == position_grey:
                        position_w = [200, 500]
                    else:
...
def two_player():
    ...
    while not winner:
        ...
        p1_card2 = color_position(p1_card2)
        p1_card_fin = card_choice_display(p1_card1, p1_card2, 'Player1')[0]
        if p1_card_fin == p1_card1:
            p1_double = p1_double1
        else:
            p1_double = p1_double2
        ...
        pos2_final = card_to_space(pos2_initial, p2_card2, p2_double)
    ...
    player1_wins = pygame.image.load('C:\\Users\\kayla\\Documents\\ENGR 102\\Final- Board Game\\Player1_winner.png')
...
def player_menu2():
    ...
    width, height = int((1601 * .7)), int((700 * .7))
    screen = pygame.display.set_mode((width, height))
    menu_2 = pygame.image.load('C:\\Users\\kayla\\Documents\\ENGR 102\\Final- Board Game\\player 1 selection.png')  # background image for menu
    selector = pygame.image.load('C:\\Users\\kayla\\Documents\\ENGR 102\\Final- Board Game\\Grey_highlight.png')
...
def menu1():
    ...
    width, height = int((1601 * .7)), int((700 * .7))
    screen = pygame.display.set_mode((width, height))
    menu1_image = pygame.image.load('C:\\Users\\kayla\\Documents\\ENGR 102\\Final- Board Game\\who will play.png')
    ...
    while not enter:
        ...
        for event in pygame.event.get():
            ...
            screen.blit(selector, position)
            pygame.display.flip()
            if 100 < mouse_position[0] < 350 and 100 < mouse_position[1] < 450:
                position = [75, 120]
                pygame.display.flip()
            elif 700 < mouse_position[0] < 1050 and 100 < mouse_position[1] < 450:
                position = [720, 120]
                pygame.display.flip()
            else:
                position = [-400, 100]
                pygame.display.flip()
            if event.type == pygame.MOUSEBUTTONDOWN:
                if 700 < mouse_position[0] < 1050 and 100 < mouse_position[1] < 450:
                    computer_mode()
                    enter = True
                elif 100 < mouse_position[0] < 350 and 100 < mouse_position[1] < 450:
                    two_player()
                    enter = True
                else:
                    enter = False
...
def rules():
    ...
    while not enter:
        ...
        for event in pygame.event.get():
            ...
            pygame.display.flip()
            if (950 > mouse_position[0] > 800) and (490 > mouse_position[1] > 390):
                position = [800, 400]
                pygame.display.flip()
            if event.type == pygame.MOUSEBUTTONDOWN:
                if 950 > mouse_position[0] > 800 and 480 > mouse_position[1] > 400:
                    menu1()  # based on where user clicks, rule screen will proceed to the first menu screen
                    enter = True
...
def welcome():
    ...
    while not enter:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if 950 > mouse_position[0] > 800 and 480 > mouse_position[1] > 400:
                    rules()  # Based on where user clicks, rule screen will proceed to the first menu screen
                    enter = True
